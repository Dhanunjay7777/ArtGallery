    ...
    return (
        <div class="main-content">
            ...
            <div className="form-container">
                <h2 style={{ textAlign: 'center' }}>Art Registration</h2>
                <form onSubmit={handleSubmit} encType="multipart/form-data">
                    ...
                    <div className="form-group">
                        <label htmlFor="artmedium">Art Medium:</label>
                        <input 
                            type="text" 
                            id="artmedium" 
                            name="artmedium" 
                    ...
                    <div className="form-group">
                        <label htmlFor="artdimensions">Art Dimensions:</label>
                        <input 
                            type="text" 
                            id="artdimensions" 
                            name="artdimensions" 
                    ...
                    <div className="form-group">
                        <label htmlFor="artcost">Art Cost:</label>
                        <input 
                            type="number" 
                            id="artcost" 
                            name="artcost" 
